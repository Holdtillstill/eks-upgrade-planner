...
import { requireProductionSiteUrl, renderRobots, renderSitemap } from './public-routes.js';

const __dirname = path.dirname(fileURLToPath(import.meta.url));
const rootDir = path.resolve(__dirname, '..');
const publicDir = path.join(rootDir, 'public');

const siteUrl = requireProductionSiteUrl(process.env.SITE_URL || process.env.VITE_SITE_URL);
